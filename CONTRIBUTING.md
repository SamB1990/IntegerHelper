...
When filing an issue, the most important thing is to include a minimal reproducible example so that i can quickly verify the problem, and then figure out how to fix it. 
Before reporting your bug, make sure to check the issue tracker for other similar bugs.
